...
# v2.1.7 already copies the image; copy again defensively so this patch can be validated independently.
...
print('Applied v2.1.8 visible global background override to main studio and Book Writer.')
