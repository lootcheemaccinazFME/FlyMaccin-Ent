...
private:std::mutex m_;fluid_settings_t*settings_=nullptr;fluid_synth_t*synth_=nullptr;std::shared_ptr<oboe::AudioStream>stream_;std::vector<Region>regions_;std::vector<Voice>voices_;float master_=.85f;
};
